...
<html>
	...
	<form method="post" action="${pageContext.request.contextPath}/ProductServlet?op=updateProduct&pid=${product.pid}" enctype="multipart/form-data">
					 ...
					 <tr>
						...
						<td width="80%" height="20" bgcolor="d3eaef" class="STYLE6"><div
							...
							<img width="200px" height="180px" src="${pageContext.request.contextPath}/files/${product.imgurl}"/>--%>
								<input type="file" id="chooseImage" name="imgurl"  value="${product.imgurl}"/><br>
						</div>
							<div id="result"><img name="imageUnmodified" id = "image" src="${product.imgurl}" height="200" width="150"></div>
