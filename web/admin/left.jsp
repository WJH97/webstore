...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">商品管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath}/AddProductServlet?op=findProduct" target="rightFrame">添加商品</a></li>
        <li><a href="${pageContext.request.contextPath}/ProductServlet?op=findAllProduct&num=1" target="rightFrame">查看/修改商品</a></li>
        <li><a href="${pageContext.request.contextPath}/ProductServlet?op=preSearchProduct" target="rightFrame">搜索商品</a></li>
      </ul>
    </li>
