				...
				<c:forEach items="${requestScope.list }" var="product" varStatus="status">
					<tr>
						<td height="20" bgcolor="#FFFFFF">
							<div align="center">
								<input type="checkbox" name="pid" id="pid" value="${product.cid }" />
							</div>
						</td>
						...
						<td height="20" bgcolor="#FFFFFF" class="STYLE19">
							<div align="center">${product.cname}</div>
						</td>
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE21">
								<a href="${pageContext.request.contextPath }/CategoryServlet?op=deleteMulti&cid=${product.cid}">删除</a>
								<a href="${pageContext.request.contextPath }/admin/category/updateCategory.jsp?cid=${product.cid}&cname=${product.cname}">编辑</a>
							</div>
						</td>
					</tr>
				</c:forEach>
